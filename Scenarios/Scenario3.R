...
nherds <- 100
nSiresPerHerd <- 5
nOffspringPerHerd <- 100 # number of offspring of one sire in herd


off_sire_g = nOffspringPerHerd
nsires_g = nSiresPerHerd
## Trait stats ##
...
rm(events)
##Write file for SIRE
Write_infectivity_file_for_SIRE(InfectedPedigree, "Scenario3.txt", timepoints)
